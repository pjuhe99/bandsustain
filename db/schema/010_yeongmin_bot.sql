...
CREATE TABLE IF NOT EXISTS yeongmin_settings (
  ...
  input_char_limit         INT          NOT NULL DEFAULT 400,
  long_input_fallback_reply TEXT        NULL,
  output_max_chars         INT          NOT NULL DEFAULT 220,
  output_max_lines         SMALLINT     NOT NULL DEFAULT 6,
  output_max_tokens        SMALLINT     NOT NULL DEFAULT 220,
