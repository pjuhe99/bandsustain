    ...
    <>
      ...
      <section className="border-t border-[var(--color-border)]">
        <div className="max-w-4xl mx-auto px-6 md:px-12 py-16 md:py-24">
          ...
          <div className="space-y-4 text-base md:text-lg leading-relaxed text-[var(--color-text)]">
          ...
          <div className="mt-8 space-y-4 text-base md:text-lg leading-relaxed text-[var(--color-text-muted)]">
